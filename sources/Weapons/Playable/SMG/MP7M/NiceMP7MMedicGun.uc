...
defaultproperties
{
    ...
    FireModeClass(0)=Class'NicePack.NiceMP7MFire'
    FireModeClass(1)=Class'NicePack.NiceMP7MAltFire'
    PutDownAnim="PutDown"
    ...
    InventoryGroup=3
    GroupOffset=5
    PickupClass=Class'NicePack.NiceMP7MPickup'
    PlayerViewOffset=(X=25.000000,Y=20.000000,Z=-6.000000)
    BobDamping=6.000000
    AttachmentClass=Class'NicePack.NiceMP7MAttachment'
